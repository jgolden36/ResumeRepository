def getData(file="C:/Users/bnhas/OneDrive/Desktop/Classes/Classes Summer 2022/Practicum/baseballData.csv"):
	import numpy as np
	import pandas as pd
...
def AnalyzeData(data=data):
	...
	X=data[['Win Percentage away','Win Percentage Home','Final Score Average Prior Away','Final Score Average Prior Home']]
